...
func init() {
	proto.RegisterType((*Bet)(nil), "mastervectormaster.lottery.lottery.Bet")
}
...
var fileDescriptor_f6913eb749032e22 = []byte{
	...
	,
}
...
func (m *Bet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Data) > 0 {
		i -= len(m.Data)
		copy(dAtA[i:], m.Data)
		i = encodeVarintBet(dAtA, i, uint64(len(m.Data)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.User) > 0 {
		i -= len(m.User)
		copy(dAtA[i:], m.User)
		i = encodeVarintBet(dAtA, i, uint64(len(m.User)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
