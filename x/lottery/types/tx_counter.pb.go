...
func (m *TxCounter) GetCounter() string {
	if m != nil {
		return m.Counter
	}
	return ""
...
var fileDescriptor_fa6b39af76b137e4 = []byte{
	...
	0xc9, 0x2f, 0x82, 0xb0, 0xf5, 0xa0, 0x8a, 0x61, 0xb4, 0x92, 0x2a, 0x17, 0x67, 0x48, 0x85, 0x33,
	0x44, 0x9b, 0x90, 0x04, 0x17, 0x3b, 0xd4, 0x04, 0x09, 0x46, 0x05, 0x46, 0x0d, 0xce, 0x20, 0x18,
	...
	0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x31, 0xed, 0xd3, 0x87, 0x39, 0xae, 0x02,
	0xce, 0x2a, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x3b, 0xd1, 0x18, 0x10, 0x00, 0x00, 0xff,
	0xff, 0xc0, 0x62, 0x22, 0x74, 0xbe, 0x00, 0x00, 0x00,
}
...
func (m *TxCounter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Counter) > 0 {
		...
		i = encodeVarintTxCounter(dAtA, i, uint64(len(m.Counter)))
		i--
		dAtA[i] = 0xa
	}
